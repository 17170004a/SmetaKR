...
public class Smeta extends JPanel{
	...
	private JTextBoxNum tfnumber;
	//поле для ввода даты сметы
	private JFormattedTextField tfdate = new JFormattedTextField(DateFormat.getDateInstance(DateFormat.SHORT));;
